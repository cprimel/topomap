...
export Point, len, l2_squared, find_angle, compute_convex_hull, alignhull
...
mutable struct Transformation
    ...
    cos::Float64
    sin::Float64
    Transformation() = new(NaN, NaN, NaN, NaN)
end
...
function compute_convex_hull(pts::Array{Point}, chull::Vector{Point})
    empty!(chull)
    n = length(pts)
    ...
    # LazySets - need to close and reverse hull ordering
